        ...
        return (
            <ScrollView style={styles.container}>
                ...
                */}
                <Flex>
                    <Flex.Item>
                        <View style={{backgroundColor: '#fff',alignItems: 'center',marginLeft:2,marginBottom:4,height:200,padding:5 }}>
                ...
                <Flex>
                    <Flex.Item>
                        <View style={{backgroundColor: '#fff',alignItems: 'center',marginRight:2,marginBottom:4,height:203,padding:5 }}>
